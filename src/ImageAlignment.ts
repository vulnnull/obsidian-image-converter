...
export class ImageAlignment extends Component {
    ...
    addAlignmentOptionsToContextMenu(menu: Menu, img: HTMLImageElement, activeFile: TFile) {
        menu.addItem((item) => {
            item
                .setTitle(strings.imageAlignment.alignImage)
                .setIcon('align-justify')
                .setSubmenu()
                .addItem((subItem) => {
                    const currentAlignment = this.getCurrentImageAlignment(img);
                    subItem
                        .setTitle(strings.imageAlignment.left)
                        .setIcon('align-left')
                ...
                .addItem((subItem) => {
                    const currentAlignment = this.getCurrentImageAlignment(img);
                    subItem
                        .setTitle(strings.imageAlignment.center)
                ...
                .addItem((subItem) => {
                    const currentAlignment = this.getCurrentImageAlignment(img);
                    subItem
                        .setTitle(strings.imageAlignment.right)
                        .setIcon('align-right')
                ...
                .addItem((subItem) => {
                    const currentAlignment = this.getCurrentImageAlignment(img);
                    subItem
                        .setTitle(strings.imageAlignment.wrapText)
